...
**And three places the zero-knowledge claim does not hold.** All three are optional, all three are off until somebody turns them on, and they are not the same shape.
